...
//function: 2 - for getting the day of birth:
...
//function: 3 - for getting the gender:
function getGender(){
  var genders = document.getElementsByName("gender");
...
//function: 4 - for print the name based on the calulation:
function getName(){
    dayValue = calculateDayValue();
    console.log("The day is", dayValue);
    getGender();
  }
